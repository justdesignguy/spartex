        ...
        <div class="banner-content">
            <div class="wrapper">
                <div class="banner-content-wrap">
                    <h2 class="sub-title">Fabric sourcing made effortless</h2>
                    <h1 class="section-title"> Your #1-stop shop for fabric </h1>
        ...
        <div class="wrapper">
            ...
            <div class="process-steps">
                <div class="process-menu">
                    <ul>
                        <li>
                            <a href="#step-1">Explore</a>
                        </li>
                        <li>
                            <a href="#step-2">PLAN </a>
                        </li>
                        <li>
                            <a href="#step-3">SOURCE </a>
                        </li>
                        <li>
                            <a href="#step-4">SAMPLES</a>
                        </li>
                        <li>
                            <a href="#step-5">ORDER</a>
                        </li>
                        <li>
                            <a href="#step-6">SHIP</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="video-wrap">
                            <div class="video-content">
                                ...
                                <ul>
                                    ...
                                    <li> Consumers provide us with the fabric detail they want by uploading photos of dresses, items, or anything which inspires them.</li>
